...
public class ApplicationContext {
    ...
    public ApplicationContext(String packageName) throws Exception {
        ...
        // 다음에서 사용할 Resources.getResourceAsFile()이 대충 다음과 같이 되어 있다
        /*
    ...
    private void injectDependency() throws Exception {
        ...
        for (Object obj : objList) {
            ...
            for (Method m : methods) {
                ...
                // Autowired가 붇지 않았으면 무시
                if (m.getAnnotation(Autowired.class) == null)
                    continue;

                // parameter 개수가 한 개가 아니라면 무시
                ...
                try {
                    // 세터의 파라미터 타입에 해당하는 객체가 objpool 보관소에서 꺼낸다.
    ...
    public Object getBean(String name) {
        ...
        if (obj == null)
            throw new RuntimeException(name + " 객체가 존재하지 않습니다.");
        return obj;
    }
    ...
    public Object getBean(Class<?> type) {
        ...
        throw new RuntimeException(type.getName() + " 객체가 존재하지 않습니다.");
    }
